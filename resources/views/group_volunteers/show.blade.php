                ...
                <div class="panel panel-default">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td> {{ $volunteer->address or '' }}</td>
                        </tr>
                        <tr>
                            <td>Where is the group from?</td>
                            <td> {{ $volunteer->origin or '' }}</td>
                        </tr>
                        <tr>
                            <td>Number of volunteers</td>
                            <td> {{ $volunteer->num_volunteers or '' }}</td>
                        </tr>
                        <tr>
                            <td>Primary age of volunteers</td>
                            <td> {{ $volunteer->age_group or '' }}</td>
                        </tr>
                        <tr>
                            <td>Affiliation:</td>
                        ...
                        <tr>
                            ...
                            <td>{{ $volunteer->speaks_spanish ? 'Yes' : 'No' }}</td>
                        </tr>
                        <tr>
