        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="responsive-table-wrapper">
                    <table class="table table-striped table-hover table-condensed" id="urgent-needs-table">
                        <thead>
                        <tr>
                            <th>Status</th>
                            <th></th>
                        ...
                        @foreach($needs as $need)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('urgent_needs.show', ['id' => $need->id]) }}"
                                        ...
                                        <a href="{{ route('urgent_needs.edit', ['id' => $need->id]) }}"
                                ...
                                <td>
                                    <div class="btn-group">
                                        <button type="button"
                                                data-id="{{ $need->id }}"
                                                data-route="{{ route('urgent_needs.update', ['id' => $need->id]) }}"
...
<script type="text/javascript" src="{{ asset('js/urgent-needs-table.bundle.js') }}"></script>
@endpush